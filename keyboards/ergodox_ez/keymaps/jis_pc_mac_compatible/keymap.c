...
[PC] = LAYOUT_ergodox(
  ...
  MO(SYMB), KC_LGUI, KC_LALT, KC_APP,  KC_INT5,
                                                KC_TRNS, KC_HOME,
                                                         KC_END,
  ...
  KC_RIGHT, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RO,
                     KC_INT4, KC_JYEN, KC_RBRC, KC_BSLS, DF(MAC),
  KC_PGUP,  KC_INS,
  KC_PGDN,
...
[MAC] = LAYOUT_ergodox(  // layer 2 : mac
  ...
  KC_LCTRL, KC_A,    KC_S,     KC_D,    KC_F,    KC_G,
  KC_LSFT,  KC_Z,    KC_X,     KC_C,    KC_V,    KC_B,    KC_LEFT,
  MO(SYMB), KC_LALT, KC_LGUI,  KC_TRNS, KC_LNG2,
                                                 KC_APP,  KC_HOME,
                                                          KC_END,
                                        KC_SPC,  KC_BSPC, KC_ESC,
  // right hand
  ...
  KC_TRNS,  KC_Y,    KC_U,     KC_I,    KC_O,    KC_P,    KC_LBRC,
            KC_H,    KC_J,     KC_K,    KC_L,    KC_SCLN, KC_QUOT,
  KC_RIGHT, KC_N,    KC_M,     KC_COMM, KC_DOT,  KC_SLSH, KC_RO,
                     KC_LNG1, KC_JYEN, KC_RBRC, KC_BSLS, DF(PC),
  KC_PGUP,  KC_INS,
  KC_PGDN,
  KC_TRNS,  KC_DEL,  KC_ENT
),
